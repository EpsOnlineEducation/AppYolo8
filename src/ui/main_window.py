...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(44, 102, 102);\n"
"border-color: rgb(119, 118, 123);")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setStyleSheet("background-color: rgb(44, 102, 102);\n"
"border-color: rgb(119, 118, 123);")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Application YOLOv8"))
        self.groupBox.setTitle(_translate("MainWindow", "Tasks/Nhiệm vụ"))
        self.radioButton_det.setText(_translate("MainWindow", "Detection/Phát hiện"))
        self.radioButton_seg.setText(_translate("MainWindow", "Segmentation/Phân đoạn"))
        self.radioButton_pose.setText(_translate("MainWindow", "Pose Estimation/Ước tính tư thế"))
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Chọn đầu vào/Inputs"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Điều chỉnh Confidence"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Điều chỉnh IoU"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Điều chỉnh Frame Interval"))
        ...
        item.setText(_translate("MainWindow", "Tọa độ hộp giới hạn - BBox"))
